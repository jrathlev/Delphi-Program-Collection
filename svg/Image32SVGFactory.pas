...
type
  ...
  private
    ...
    procedure SetInvert(const IsInverted : Boolean);
...
function TImage32SVG.GetInvert: Boolean;
begin
  Result := FInvert;
end;
...
begin
  ...
  if FInvert then FImage32.InvertColors;     // JR May 2025
...
procedure TImage32SVG.SetInvert(const IsInverted : Boolean);
begin
  if IsInverted<>FInvert then FInvert:=IsInverted;
  end;
