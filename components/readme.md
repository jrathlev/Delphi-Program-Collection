...
- **JrButtons**: Contains the visual components *TJrButton* and *TJrSpeedButton*. These components are replacements for *TBitButton* and *TSpeedButton* in Delphi versions before 10.4 (Sydney) to use the [SVG image lists](https://github.com/EtheaDev/SVGIconImageList)  provided by [Ethea](https://www.ethea.it/docs/SVGIconImageList). 
