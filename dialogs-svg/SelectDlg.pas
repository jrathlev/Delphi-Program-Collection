(* Delphi Unit
   ...
   Vers. 1 - June 2009
   Vers. 2 - Jan. 2025: uses SVG images for icons
...
uses Winapi.Windows, System.SysUtils, System.Classes, Vcl.Graphics, Vcl.Forms,
  ...
  Vcl.ImgList, System.ImageList, SVGIconImage, SVGIconImageListBase,
  SVGIconImageList;
...
uses Vcl.Consts, GnuGetText, WinUtils, ImageLoader;
...
begin
  ...
  for j:=0 to nl-1 do begin
    ...
    with Buttons[k] do begin
      ...
      if k=n-1 then begin
        if length(FDefault)=0 then Caption:=dgettext('dialogs-svg','Cancel')
...
procedure TSelectDialog.FormAfterMonitorDpiChanged(Sender: TObject; OldDPI,
  NewDPI: Integer);
begin
